--p_0020_SP_001_results_searchable.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
create Procedure p_0020_SP_001_results_searchable(
						...
						(
							(
								...
								(
										...
										OR (RTRIM(LTRIM(UPPER([Application]))) like '%' +  RTRIM(LTRIM(UPPER(@SearchString))) + '%')			
