--p_0021_CREATE_TABLE_T004_NON_Billable_Service.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
IF OBJECT_ID('dbo.T004_NON_Billable_Service') IS NOT NULL
    DROP TABLE dbo.T004_NON_Billable_Service

go

CREATE TABLE [dbo].[T004_NON_Billable_Service]
(
		...
		[Adult] [bit] NULL CONSTRAINT T004_NON_Billable_Service$Default$Zero  DEFAULT ((0)),

		[T004_RowVersion] [timestamp] NULL
	,CONSTRAINT [T004_NON_Billable_Service$T004_PK] PRIMARY KEY NONCLUSTERED 
		(
			[T004_PK] ASC
		)
		WITH 
