--p_0021_CREATE_TABLE_T003_Billable_Service.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
IF OBJECT_ID('dbo.T003_Billable_Service') IS NOT NULL
    DROP TABLE dbo.T003_Billable_Service

go

CREATE TABLE [dbo].[T003_Billable_Service]
(
		...
		[Adult] [bit] NULL CONSTRAINT T003_Billable_Service$Default$Zero  DEFAULT ((0)),

		[T003_RowVersion] [timestamp] NULL
	,CONSTRAINT [T003_Billable_Service$T003_PK] PRIMARY KEY NONCLUSTERED 
		(
			[T003_PK] ASC
		)
		WITH 
