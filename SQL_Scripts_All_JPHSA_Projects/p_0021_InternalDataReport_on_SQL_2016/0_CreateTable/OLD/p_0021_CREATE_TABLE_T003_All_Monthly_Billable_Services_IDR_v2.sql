--p_0021_CREATE_TABLE_T003_All_Monthly_Billable_Services_IDR_v2.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
IF OBJECT_ID('dbo.T003_All_Monthly_Billable_Services_IDR') IS NOT NULL
    DROP TABLE dbo.T003_All_Monthly_Billable_Services_IDR
...
(
		...
		[Adult] [bit] NULL CONSTRAINT T003_All_Monthly_Billable_Services_IDR$Default$Zero  DEFAULT ((0)),
