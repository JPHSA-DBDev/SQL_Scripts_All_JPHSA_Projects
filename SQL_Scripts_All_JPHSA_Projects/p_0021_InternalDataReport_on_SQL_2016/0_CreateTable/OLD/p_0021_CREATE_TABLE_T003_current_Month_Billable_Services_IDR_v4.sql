--p_0021_CREATE_TABLE_T003_current_Month_Billable_Services_IDR_v4.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
IF OBJECT_ID('dbo.T003_current_Month_Billable_Services_IDR') IS NOT NULL
    DROP TABLE dbo.T003_current_Month_Billable_Services_IDR

go

CREATE TABLE [dbo].[T003_current_Month_Billable_Services_IDR]
(
		...
		[Adult] [bit] NULL CONSTRAINT T003_current_Month_Billable_Services_IDR$Default$Zero  DEFAULT ((0)),

		[T003_RowVersion] [timestamp] NULL
	,CONSTRAINT [T003_current_Month_Billable_Services_IDR$T003_PK] PRIMARY KEY NONCLUSTERED 
		(
			[T003_PK] ASC
		)
		WITH 
