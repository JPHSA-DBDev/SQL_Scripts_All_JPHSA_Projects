...
SELECT @Date_Start_of_Quarter = '04-01-2016'
SELECT @Date_End_of_Quarter = '06-30-2017'
----------------------- Local Variables
DECLARE @LineNumber int
DECLARE @Source nvarchar(100)
DECLARE @Title nvarchar(255)
----------------------------------------
IF OBJECT_ID('dbo.zzz_p0021_7_IDR_part_Q_Results') IS NOT NULL
    DROP TABLE dbo.zzz_p0021_7_IDR_part_Q_Results


CREATE TABLE [dbo].[zzz_p0021_7_IDR_part_Q_Results]
(
		[IDR_Q_PK] [int] IDENTITY(1,1) NOT NULL,		
		[LineNumber] [int] NOT NULL,
		[Source] nvarchar(100) NOT NULL,
		[Line_Title] nvarchar(255) NOT NULL,
		[DateTime_Created] [datetime] NOT NULL CONSTRAINT IDR_q_7_TheDateTime_Default_GETDATE DEFAULT GETDATE(),
		[Result] [int] NOT NULL,
		[IDR_Q_RowVersion] [timestamp] NULL
	,CONSTRAINT [zzz_p0021_7_IDR_part_Q_Results$IDR_Q_PK] PRIMARY KEY NONCLUSTERED 
		(
			[IDR_Q_PK] ASC
		)
		WITH 
...
INSERT INTO [Success].[dbo].[zzz_p0021_7_IDR_part_Q_Results] 
		(
		[LineNumber],
		[Source],
		[Line_Title],
...
VALUES
		(
			...
			, ( 
					(
						SELECT TOP(1) Result 
						FROM [Success].[dbo].[zzz_p0021_7_IDR_part_Q_Results] 
						WHERE LineNumber = 22
					)
					-
					(
...
----SELECT * from [Success].[dbo].[zzz_p0021_7_IDR_part_Q_Results] 
