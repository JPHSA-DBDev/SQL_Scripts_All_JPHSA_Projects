--p_0021_SP_002_A_step_3_v0.sql
--===========================================================================
/* 	
 
	DESCIPTION: Check Assumptions
			1] There should be just two [Office_Location] present in the table [T003_All_Monthly_Billable_Services_IDR]:
				--WB JeffCare
				--EB JeffCare
			2] No records in [T003_All_Monthly_Billable_Services_IDR] should have a null ‘LOC’ field
...
--==============================================================
--==============================================================================================
SELECT 'There should be just two [Office_Location] present in the table [T003_All_Monthly_Billable_Services_IDR]'

SELECT  [Office_Location], count(*) as theCount
From [T003_All_Monthly_Billable_Services_IDR]
Group By [Office_Location]
--==============================================================================================
SELECT 'No records in [T003_All_Monthly_Billable_Services_IDR] should have a null ‘LOC’ field'
...
(
		SELECT     
					...
					t3.[Adult]
		FROM         
					dbo.T003_All_Monthly_Billable_Services_IDR t3 
					INNER JOIN
...
SELECT top(10) * FROM zzz_p0021_4_for_Analysis_of_Part_A