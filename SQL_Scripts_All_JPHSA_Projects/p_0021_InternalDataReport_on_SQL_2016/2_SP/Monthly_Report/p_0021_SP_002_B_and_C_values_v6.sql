--p_0021_SP_002_B_and_C_values_v6.sql
/*
	************************************************************************************
...
----------------------------------------
IF OBJECT_ID('dbo.zzz_p0021_1_IDR_Monthly_part_B_and_C_Results') IS NOT NULL
    DROP TABLE dbo.zzz_p0021_1_IDR_Monthly_part_B_and_C_Results


CREATE TABLE [dbo].[zzz_p0021_1_IDR_Monthly_part_B_and_C_Results]
(
	...
	,CONSTRAINT [zzz_p0021_1_IDR_Monthly_part_B_and_C_Results$IDR_a_b_PK] PRIMARY KEY NONCLUSTERED 
		(
			[IDR_a_b_PK] ASC
		)
		WITH 
...
INSERT INTO [Success].[dbo].[zzz_p0021_1_IDR_Monthly_part_B_and_C_Results] 
		(
		[LineNumber],
		[Source],
		[Line_Title],
...
--SELECT * from [Success].[dbo].[zzz_p0021_1_IDR_Monthly_part_B_and_C_Results] 
...
VALUES
		(
			...
			, ( 
					(
						SELECT TOP(1) Result 
						FROM [Success].[dbo].[zzz_p0021_1_IDR_Monthly_part_B_and_C_Results] 
						WHERE LineNumber = 4
					)
					-
					(
