--p_0021_SP_005_MultipleMonths_B_and_C_values_v1.sql
/*
	...
	************************************************************************************
	...
	Uses: 
			...
			Stores results in [zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS]


	Created: 03/14/2017
	Modified: 4/18/2017 for multiple months
	Modified: 4/127/2017 change name of results table
	By: glenn garson
	************************************************************************************
*/
USE [Success];
...
SELECT @EndDate_DateRange = '06-30-2017'	
...
----------------------------------------
IF OBJECT_ID('dbo.zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS') IS NOT NULL
    DROP TABLE dbo.zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS


CREATE TABLE [dbo].[zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS]
(
		[IDR_a_b_PK] [int] IDENTITY(1,1) NOT NULL,		
		[LineNumber] [int] NOT NULL,
		[Source] nvarchar(100) NOT NULL,
		[Line_Title] nvarchar(255) NOT NULL,
		[DateTime_Created] [datetime] NOT NULL CONSTRAINT IDR_b_c_TheDateTime_Default_GETDATE DEFAULT GETDATE(),
		[Result] [int] NOT NULL,
		[YYYY_MM] nvarchar(7),
		[IDR_a_b_RowVersion] [timestamp] NULL
	,CONSTRAINT [zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS$IDR_a_b_PK] PRIMARY KEY NONCLUSTERED 
		(
			[IDR_a_b_PK] ASC
		)
		WITH 
...
INSERT INTO [Success].[dbo].[zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS] 
		(
		[LineNumber],
		[Source],
		[Line_Title],
...
--SELECT * from [Success].[dbo].[zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS] 
...
SELECT  
  ...
  FROM [Success].[dbo].[zzz_p0021_21_IDR_MultiMonth_part_B_and_C_RESULTS]
    WHERE 
		[LineNumber] = 4
		or 
		[LineNumber] = 5
