--p_0021_SP_005_MultipleMonths_A_step_3_v1.sql
--===========================================================================
/* 	
	...
	DESCIPTION: Check Assumptions should have been done in the monthly scripts.
			...
			There should be two values for NBTYPE in [zzz_p0021_22_NonBillServices_for_IDR], 
	...
	Modified: 4/26/2017 now using : [zzz_p0021_22_NonBillServices_for_IDR]
	By: glenn garson
...
(
		SELECT     
					...
					t1.Type,
					t3.[Adult]
					,t3.Data_for_Month_MM								
					,t3.[Data_for_Year_YYYY]
...
UNION ALL
		SELECT     
					...
					z2.NonBillable_Type,
					z2.[Adult]
					,z2.[Data_for_Month_MM]
					,z2.[Data_for_Year_YYYY]


		FROM         
					--dbo.T004_ARCHIVE_NonBillable_Services_IDR z2 
					dbo.zzz_p0021_22_NonBillServices_for_IDR z2
					INNER JOIN
					dbo.T001_Provider_Information_IDR t1 
