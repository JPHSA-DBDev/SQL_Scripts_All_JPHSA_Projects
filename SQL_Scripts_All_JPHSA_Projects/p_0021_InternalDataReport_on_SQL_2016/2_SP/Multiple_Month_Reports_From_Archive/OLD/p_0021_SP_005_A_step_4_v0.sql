...
--++++++++++++++++++++++++++++++++++++++++++++++
IF OBJECT_ID('dbo.zzz_p0021_26_nonBill_DataFromARCHIVE_for_DateRange') IS NOT NULL
    DROP TABLE dbo.zzz_p0021_26_nonBill_DataFromARCHIVE_for_DateRange


SELECT [ARCHIVE_T004_PK]
      ...
      ,[Adult]
      ,[DateTime_Archived]
	INTO	dbo.zzz_p0021_26_nonBill_DataFromARCHIVE_for_DateRange
	FROM [Success].[dbo].[T004_ARCHIVE_NonBillable_Services_IDR]
	WHERE	
			([Date_Encounter]  >= @BeginDate_DateRange)
			AND
			([Date_Encounter]  <= @EndDate_DateRange)
...
(
	...
	,CONSTRAINT [zzz_p0021_21_IDR_part_A$IDR_a_PK] PRIMARY KEY NONCLUSTERED 
		(
			[IDR_a_PK] ASC
		)
		WITH 
...
(
	SELECT distinct
		  ...
		  [YYYY_MM]
		 FROM [Success].[dbo].[zzz_p0021_26_nonBill_DataFromARCHIVE_for_DateRange] t3
