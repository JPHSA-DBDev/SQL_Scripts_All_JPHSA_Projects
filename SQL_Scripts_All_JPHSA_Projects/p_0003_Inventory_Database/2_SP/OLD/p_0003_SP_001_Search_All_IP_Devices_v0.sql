--p_0003_SP_001_Search_All_IP_Devices_v0.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
	...
	WHERE
			(
				...
				(
						...
						OR (RTRIM(LTRIM(UPPER([Monitor-1_JPHSA_Tag]))) like '%' +  RTRIM(LTRIM(UPPER(@SearchString))) + '%')			
						OR (RTRIM(LTRIM(UPPER([Monitor-2_JPHSA_Tag]))) like '%' +  RTRIM(LTRIM(UPPER(@SearchString))) + '%' )	
						OR (RTRIM(LTRIM(UPPER([Monitor-3_JPHSA_Tag]))) like '%' +  RTRIM(LTRIM(UPPER(@SearchString))) + '%' )	
