--p_0003_vw_501_All_IP_Devices_v0.sql
/*
	************************************************************************************
	NOTE: 
	Uses: 
...
SELECT 
			...
			,t6_1.JPHSA_Tag AS [Monitor-1_JPHSA_Tag]
			--,t4.[Monitor-1_FK]
			,t6_2.JPHSA_Tag AS [Monitor-2_JPHSA_Tag]
			--,t4.[Monitor-2_FK]
			,t6_3.JPHSA_Tag AS [Monitor-3_JPHSA_Tag]
			--,t4.[Monitor-3_FK]
...
FROM            
		...
		ON 
			t4.[Monitor-1_FK] = t6_1.T006_Monitor_Inventory_PK 

		LEFT OUTER JOIN
		T006_Monitor_Inventory t6_2
		ON 
			t4.[Monitor-2_FK] = t6_2.T006_Monitor_Inventory_PK 

		LEFT OUTER JOIN
		T006_Monitor_Inventory t6_3
		ON 
			t4.[Monitor-3_FK] = t6_3.T006_Monitor_Inventory_PK
